...
project = u'Project 2 (Explore Titanic Data Set)'
copyright = u'2016, the cloistered monkey'
...
html_short_title = 'Titanic Data Exploration'
...
latex_documents = [
  ('index', 'titanic_exploration.tex', basename,
   u'russelln', 'howto'),
]
